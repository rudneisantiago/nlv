...
export function HabitDay({
  ...
  return (
    <Popover.Root>
      <Popover.Trigger
        className={clsx(
          "w-10 h-10 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:via-violet-600 focus:ring-offset-2 focus:ring-offset-background",
          {
      ...
      <Popover.Portal>
        <Popover.Content className="min-w-[320px] w-full p-6 rounded-2xl bg-zinc-900 flex flex-col">
          ...
          <span className="mt-4 font-extrabold leading-tight text-3xl">
            {dayAndMonth}
          </span>
